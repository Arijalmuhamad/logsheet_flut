...
class DeodorizingFiltrationEntity {
  ...
  /// FIT 704 ( RPO ) - tph
  final double? fit704Rpo;

  /// E 704 - c
  final double? e704;

  /// FIT 705 ( PFAD ) - bar
  final double? fit705Pfad;
  ...
  DeodorizingFiltrationEntity({
    ...
    required this.f702B,
    required this.f702C,
    required this.fit704Rpo,
    required this.e704,
    required this.fit705Pfad,
    required this.e705,
  ...
  factory DeodorizingFiltrationEntity.fromMap(Map<String, dynamic> map) {
    ...
    return DeodorizingFiltrationEntity(
      ...
      shift: combinedDateTime != null ? getShift(combinedDateTime) : null,
      ...
      fit704Rpo: tryParseDouble(map['fit704_rpo']),
      e704: tryParseDouble(map['e704']),
      fit705Pfad: tryParseDouble(map['fit_705_pfad']),
      ...
      fit701Bpo: tryParseDouble(map['fit701_bpo']),
    );
  }
  ...
  Map<String, dynamic> toMap() {
    ...
    return <String, dynamic>{
      ...
      'f702_b': f702B,
      'f702_c': f702C,
      'fit704_rpo': fit704Rpo,
      'e704': e704,
      'fit_705_pfad': fit705Pfad,
      'e705': e705,
      'clarity': clarity,
      'remarks': remarks,
      'entry_by': entryBy,
