...
class MaintenanceChangeProductionChecklistHeaderEntity {
  ...
  // Constructor
  MaintenanceChangeProductionChecklistHeaderEntity({
    required this.id,
  ...
  factory MaintenanceChangeProductionChecklistHeaderEntity.fromMap(
    Map<String, dynamic> map,
  ) {
    return MaintenanceChangeProductionChecklistHeaderEntity(
      id: map['id'] as String,
  ...
  MaintenanceChangeProductionChecklistHeaderEntity copyWith({
    String? id,
    String? company,
    String? plant,
    ...
    return MaintenanceChangeProductionChecklistHeaderEntity(
      ...
      nextProduct: nextProduct ?? this.nextProduct,
