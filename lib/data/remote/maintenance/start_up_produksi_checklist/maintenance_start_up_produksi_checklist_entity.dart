...
class MaintenanceStartUpProduksiChecklistEntity {
  final String code;
  final String? name;
  final int? sortNo;
  ...
  MaintenanceStartUpProduksiChecklistEntity({
    required this.code,
    required this.name,
  ...
  factory MaintenanceStartUpProduksiChecklistEntity.fromMap(
    Map<String, dynamic> map,
  ) {
    return MaintenanceStartUpProduksiChecklistEntity(
  ...
  MaintenanceStartUpProduksiChecklistEntity copyWith({
    String? code,
    String? name,
    int? sortNo,
    String? category,
