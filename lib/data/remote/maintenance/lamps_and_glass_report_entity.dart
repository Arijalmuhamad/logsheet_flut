class LampsAndGlassReportEntity {
  final String id;
  ...
  factory LampsAndGlassReportEntity.fromMap(Map<String, dynamic> map) {
    ...
    return LampsAndGlassReportEntity(
      id: map['id'] as String,
      company: map['company'] as String,
      plant: map['plant'] as String,
      workCenter: map['work_center'] as String,
      checkDate:
          parseDateTime(map['check_date']) as DateTime, // must use parsing
      remarks: map['remarks'] as String,
      entryBy: map['entry_by'] as String,
      entryDate:
          parseDateTime(map['entry_date']) as DateTime, // must use parsing
