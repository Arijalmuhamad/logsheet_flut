...
class DailyStorageTankAnalyticalReportListPage extends StatefulWidget {
  const DailyStorageTankAnalyticalReportListPage({super.key});

  @override
  State<DailyStorageTankAnalyticalReportListPage> createState() =>
      _DailyStorageTankAnalyticalReportListPageState();
}

class _DailyStorageTankAnalyticalReportListPageState
    extends State<DailyStorageTankAnalyticalReportListPage> {
    ...
    return InkWell(
      onTap: () {
        Navigator.push(
          ...
          MaterialPageRoute(
            builder:
                (context) => DailyStorageTankAnalyticalReportDetailPage(id: id),
          ),
        ).then((_) {
