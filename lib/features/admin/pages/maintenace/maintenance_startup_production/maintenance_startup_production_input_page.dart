              ...
              children: [
                ...
                Consumer<ValueProvider>(
                  builder: (
                    ...
                    if (selectedPlant == 'Refinery') {
                      workCenterList = provider.workCenterLists;
                    } else if (selectedPlant == 'Fractination') {
                      workCenterList = provider.workCenterFractLists;
                    }
                ...
                Consumer<ProductProvider>(
                  builder: (
                    ...
                    List<String> dynamicProductList = [];
                    ...
                    // Jika selectedPlant null, list akan otomatis kosong
                    return Column(
                      crossAxisAlignment: CrossAxisAlignment.stretch,
                      children: [
                        CustomDropdown.fromStringItems(
