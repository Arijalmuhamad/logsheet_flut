...
class MaintenanceStartupProductionApprovalDetailPage extends StatefulWidget {
  String id;

  MaintenanceStartupProductionApprovalDetailPage({super.key, required this.id});

  @override
  State<MaintenanceStartupProductionApprovalDetailPage> createState() =>
      _MaintenanceStartupProductionApprovalDetailPageState();
}

class _MaintenanceStartupProductionApprovalDetailPageState
    extends State<MaintenanceStartupProductionApprovalDetailPage> {
  MaintenanceStartUpProduksiChecklistReportEntity? approvalItem;
        ...
        child: Column(
          children: [
            ...
            _buildSection('General Information', [
              ...
              _buildDataRow('Product', approvalItem!.product ?? ''),
