...
class MaintenanceChangeProductEditPage extends StatefulWidget {
  String id;
  MaintenanceChangeProductEditPage({super.key, required this.id});

  @override
  State<MaintenanceChangeProductEditPage> createState() =>
      _MaintenanceChangeProductEditPageState();
}

class _MaintenanceChangeProductEditPageState
    extends State<MaintenanceChangeProductEditPage> {
