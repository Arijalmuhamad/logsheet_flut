...
class _DeodorizingFiltrationInputPageState
  ...
  void initState() {
    ...
    selectedOilType = widget.logsheet.oilTypeId;
    selectedOilTypeFg = widget.logsheet.oilTypeFgId;
    selectedOilTypeBp = widget.logsheet.oilTypeBpId;
