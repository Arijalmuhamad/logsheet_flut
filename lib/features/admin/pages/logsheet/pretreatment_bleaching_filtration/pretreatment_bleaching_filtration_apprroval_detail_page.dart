...
class PretreatmentBleachingFiltrationApprovalDetailPage extends StatefulWidget {
  final List<PretreatmentBleachingFiltrationEntity> reportEntities;
  final String reportIdentifier;
  const PretreatmentBleachingFiltrationApprovalDetailPage({
    super.key,
  ...
  @override
  State<PretreatmentBleachingFiltrationApprovalDetailPage> createState() =>
      _PretreatmentBleachingFiltrationApprovalDetailPageState();
}

class _PretreatmentBleachingFiltrationApprovalDetailPageState
    extends State<PretreatmentBleachingFiltrationApprovalDetailPage> {
  final _remarkController = TextEditingController();

  @override
  Widget build(BuildContext context) {
    log(widget.reportIdentifier);
    final Map<int?, List<PretreatmentBleachingFiltrationEntity>>
    groupedByShift = {};
  ...
  Future<dynamic> _buildBottomSheet(
    ...
    PretreatmentBleachingFiltrationEntity report,
    String username,
    String role,
  ) {
