...
// class MySQLClient {
//   Future<({MySQLConnection? connection, String? error})> getConnection() async {
//     try {
...
//     } catch (e) {
//       return (connection: null, error: e.toString());
//     }
//   }
...
//   return await mySQLClient.getConnection();
// }

// Future<void> closeMySQLConnection(MySQLConnection? connection) async {
//   return await mySQLClient.closeConnection(connection);
// }
